...
class RacecarSimulator
{
        ...
        : im_server("racecar_sim")
    {
        ...
        // Get the topic names
        std::string drive_topic, map_topic, scan_topic, pose_topic, gt_pose_topic, pose_rviz_topic, odom_topic,
            imu_topic;
        ...
        car_distances = Precompute::get_car_distances(scan_beams, params.wheelbase, width, scan_distance_to_base_link,
    ...
    void update_pose(const ros::TimerEvent&)
    {
        ...
        state = STKinematics::update(state, accel, steer_angle_vel, params, current_seconds - previous_seconds);
    ...
    void map_callback(const nav_msgs::OccupancyGrid& msg)
    {
        ...
        scan_simulator.set_map(map, height, width, resolution, origin, map_free_threshold);
        map_exists = true;
    }
