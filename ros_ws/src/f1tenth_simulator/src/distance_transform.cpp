...
void DistanceTransform::distance_squared_1d(const std::vector<double>& input, std::vector<double>& output)
{
    ...
    for (size_t idx = 1; idx < input.size(); idx++)
    {
        ...
        do
        {
            ...
            //
            intersection_point = ((input[idx] + idx * idx) - (input[parabola_idx] + parabola_idx * parabola_idx)) /
                (2 * (idx - parabola_idx));
...
void DistanceTransform::distance_squared_2d(std::vector<double>& input, size_t width, size_t height,
...
void DistanceTransform::distance_2d(std::vector<double>& input, size_t width, size_t height, double resolution,
                                    double boundary_value)
{
