...
\end{axis}
\end{tikzpicture}
\caption \textbf{___PH_TITLE___:} Geschwindigkeit $\Delta v$ nach Distanz $d$ und Lenkwinkel $\psi$ - ___PH_SIZE___ Schritte
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption \textbf{___PH_TITLE___:} Geschwindigkeit $\Delta v$ nach Zeit $t$ und Lenkwinkel $\psi$ - ___PH_SIZE___ Schritte
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption \textbf{___PH_TITLE___:} Beschleunigung $a$ nach Distanz $d$ und Lenkwinkel $\psi$ - ___PH_SIZE___ Schritte
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption \textbf{___PH_TITLE___:} Beschleunigung $a$ nach Zeit $t$ und Lenkwinkel $\psi$ - ___PH_SIZE___ Schritte
\end{figure}
